...
//  Serial.println(); Serial.println();
 ...
 printTAB(pose);
  ...
  do {
    ...
    manipulator.getJointAngles(jointAngles);
    Serial.print(jointAngles[0]*180/PI);
    Serial.print("\t");
    Serial.print(jointAngles[1]*180/PI);
    Serial.print("\t");
    Serial.print(jointAngles[2]*180/PI);
    Serial.print("\t");
    Serial.print(jointAngles[3]*180/PI);
    Serial.print("\t");
    Serial.print(jointAngles[4]*180/PI);
    Serial.print("\t");
    Serial.print(jointAngles[5]*180/PI);
    Serial.println();
