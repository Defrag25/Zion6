...
{
    MatriceDUE.Copy((mtx_type*)this->eye, 4, 4, (mtx_type*)this->links[0].H0);
    MatriceDUE.Copy((mtx_type*)this->eye, 4, 4, (mtx_type*)this->links[0].fromJoint->H);
    ...
    //MatriceDUE.Print((mtx_type*)this->links[0].H0, 4, 4, "H0");
    ...
    {
        MatriceDUE.Copy((mtx_type*)this->links[i-1].H0, 4, 4, (mtx_type*)this->links[i].H0);
        MatriceDUE.Copy((mtx_type*)this->eye, 4, 4, (mtx_type*)this->links[i].fromJoint->H);
...
SixDOF::IKState_t SixDOF::inverseKinematics(double x, double y, double z, double phi, double theta, double psi, double grippingOffset, double alpha)
{
    ...
    //MatriceDUE.Print((mtx_type*)bufferR, 3, 3, "bufferR");

    MatriceDUE.Multiply((mtx_type*)bufferR, (mtx_type*)bufferU, 3, 3, 1, (mtx_type*)bufferW);
    MatriceDUE.Scale((mtx_type*)bufferW, 3, 1, this->links[this->numJoints-1].length+grippingOffset);
    MatriceDUE.Subtract((mtx_type*)bufferV, (mtx_type*)bufferW, 3, 1, (mtx_type*)oc);

    MatriceDUE.Multiply((mtx_type*)bufferR, (mtx_type*)bufferU, 3, 3, 1, (mtx_type*)bufferW);
    MatriceDUE.Scale((mtx_type*)bufferW, 3, 1, grippingOffset);
    MatriceDUE.Subtract((mtx_type*)bufferV, (mtx_type*)bufferW, 3, 1, (mtx_type*)bufferU);

    x = bufferU[0];
    y = bufferU[1];
    z = bufferU[2];

 //MatriceDUE.Print((mtx_type*)oc, 3, 1, "oc");
    ...
    while (b > REACHED_DESTINATION_THRESHOLD && count++ < INVKIN_TIMEOUT) 
    {
        ...
        //MatriceDUE.Print((mtx_type*)this->bufferU, 3, 1, "bufferU");
...
Serial.println("Step 3");       
 ...
 time = millis() - time;
   ...
   Serial.println("Step 5");delay(100);
...
SixDOF::IKState_t SixDOF::inverseKinematics2(double x, double y, double z, double phi, double theta, double psi, double grippingOffset, double alpha)
{
    ...
    while(true)
    {
      ...
      MatriceDUE.Transpose((mtx_type*)bufferR2, 3, 3, (mtx_type*)bufferR3);
      MatriceDUE.Multiply((mtx_type*)bufferR3, (mtx_type*)bufferR, 3, 3, 3, (mtx_type*)bufferR2);
      ...
      //MatriceDUE.Print((mtx_type*)J, 6, this->numJoints, "J");

      MatriceDUE.Transpose((mtx_type*)J, 6, this->numJoints, (mtx_type*)transposeJ);
      MatriceDUE.Multiply((mtx_type*)transposeJ, (mtx_type*)J, this->numJoints, 6, this->numJoints, (mtx_type*)bufferinvJ);
      
      int success = MatriceDUE.Invert((mtx_type*)bufferinvJ, this->numJoints);
      if (success == 0) {
        this->ikStatus = FAILED;
        break;
      }

      MatriceDUE.Multiply((mtx_type*)bufferinvJ, (mtx_type*)transposeJ, this->numJoints, this->numJoints, 6, (mtx_type*)invJ);

      MatriceDUE.Multiply((mtx_type*)invJ, (mtx_type*)error, this->numJoints, 6, 1, (mtx_type*)dAngles);
...
void SixDOF::computeJointJacobian(mtx_type* endH, mtx_type* prevH, mtx_type* J) 
{
    ...
    MatriceDUE.Subtract((mtx_type*)oEnd, (mtx_type*)oPrev, 3, 1, (mtx_type*)bufferU);
...
void SixDOF::screwZ(double theta, double d, mtx_type* H)
{
    ...
    MatriceDUE.Multiply((mtx_type*)H, (mtx_type*)bufferH, 4, 4, 4, (mtx_type*)bufferH2);
    MatriceDUE.Copy((mtx_type*)bufferH2, 4, 4, (mtx_type*)H);
    delete[] bufferH;
    delete[] bufferH2;
}
...
void SixDOF::crossProduct(mtx_type* v, mtx_type* u, mtx_type* w) 
{
    ...
    MatriceDUE.Scale((mtx_type*)this->v_i, 3, 1, jk);
    MatriceDUE.Scale((mtx_type*)this->v_j, 3, 1, ik);
    MatriceDUE.Scale((mtx_type*)this->v_k, 3, 1, ij);

    mtx_type* bufferV = new mtx_type[3];
    
    MatriceDUE.Subtract((mtx_type*)this->v_i, (mtx_type*)this->v_j, 3, 1, (mtx_type*)bufferV);
    MatriceDUE.Add((mtx_type*)bufferV, (mtx_type*)this->v_k, 3, 1, (mtx_type*)w);
...
void SixDOF::rotZ(double theta, mtx_type* R)
{
    ...
    MatriceDUE.Multiply((mtx_type*)R, (mtx_type*)bufferR, 3, 3, 3, (mtx_type*)result);
    MatriceDUE.Copy((mtx_type*)result, 3, 3, (mtx_type*)R);
    delete[] bufferR;
    delete[] result;
}
...
void SixDOF::euler2angvel(mtx_type* eulerFrom, mtx_type* eulerTo, mtx_type* angVel) 
{
  ...
  MatriceDUE.Copy((mtx_type*)this->bufferR3, 3, 3, (mtx_type*)this->bufferR2);

  MatriceDUE.Transpose((mtx_type*)this->bufferR2, 3, 3, (mtx_type*)this->bufferR5);
  MatriceDUE.Multiply((mtx_type*)this->bufferR4, (mtx_type*)this->bufferR5, 3, 3, 3, (mtx_type*)this->bufferR);
  ...
  MatriceDUE.Multiply((mtx_type*)this->bufferR2, (mtx_type*)this->bufferW, 3, 3, 1, (mtx_type*)angVel);
}*/
...
void SixDOF::rot2axis(mtx_type* R, mtx_type* ax)
{
    if (fabs(traceR(R)-3) < SINGULARITY_THRESHOLD) {
      ...
      MatriceDUE.Transpose((mtx_type*)R, 3, 3, (mtx_type*)transposeR);
      MatriceDUE.Subtract((mtx_type*)R, (mtx_type*)transposeR, 3, 3, (mtx_type*)skw);
      MatriceDUE.Scale((mtx_type*)skw, 3, 3, 0.5/sin(ax[3]));
...
void SixDOF::eigDecomp(mtx_type* A, int m, int n, int iterations, mtx_type* out) 
{
  ...
  for (int i = 0; i < iterations; i++) {
    ...
    MatriceDUE.Multiply((mtx_type*)A, (mtx_type*)b_k, m, n, 1, (mtx_type*)b_k1);
    // calculate the norm
    double norm = 0;
    for (int j = 0; j < n; j++) {
    ...
    MatriceDUE.Scale((mtx_type*)b_k1, n, 1, 1/norm);
    MatriceDUE.Copy((mtx_type*)b_k1, n, 1, (mtx_type*)b_k);
    
  }
  
  MatriceDUE.Copy((mtx_type*)b_k, n, 1, (mtx_type*)out);
