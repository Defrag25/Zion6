...
//.marginLeft = 15; //move to the right;
     ...
     ShowPen     = cp5.addToggle("Pen")    .setPosition(170,250).setSize(50,20).setValue(true).setMode(ControlP5.SWITCH)  ;
     ShowSheet   = cp5.addToggle("Sheet")  .setPosition(240,250).setSize(50,20).setValue(true).setMode(ControlP5.SWITCH)  ;
     ShowTraj    = cp5.addToggle("Traj")   .setPosition(310,250).setSize(50,20).setValue(true).setMode(ControlP5.SWITCH)  ;
     ...
     SliderAxe2 = cp5.addSlider("Axe2").setPosition(10, 590).setSize(390, 20).setRange(-100, 90).setLabel("Axe2").setSliderMode(Slider.FLEXIBLE).setNumberOfTickMarks(18);
     ...
     PtZ = cp5.addSlider("PtZ").setPosition(10, 400).setSize(390, 20).setRange(-100, 100).setLabel("Z").setSliderMode(Slider.FLEXIBLE).setNumberOfTickMarks(18);
