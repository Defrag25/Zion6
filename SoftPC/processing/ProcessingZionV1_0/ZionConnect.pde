...
void GUI_CONNECT() {
  ...
  G17    = cp5.addButton("G17").setPosition(730, 100).setSize(90, 20).setLabel("G17");
  G18    = cp5.addButton("G18").setPosition(730, 140).setSize(90, 20).setLabel("G18");
  G19    = cp5.addButton("G19").setPosition(730, 180).setSize(90, 20).setLabel("G19");
  cercle = cp5.addButton("cercle").setPosition(730, 220).setSize(90, 20).setLabel("cercle");
  Run    = cp5.addButton("Run").setPosition(730, 260).setSize(90, 20).setLabel("Run");
  ...
  ShowAll=cp5.addToggle("ShowAll")
    ...
    .hide();
  ShowAllLabel=cp5.addTextlabel("ShowAllLabel").setText("All").setPosition(580, 65).setColorValue(#00FF00).setFont(font).hide();
 ...
 ShowCMDLabel=cp5.addTextlabel("ShowCMDLabel").setText("CMD").setPosition(580, 90).setColorValue(#00FF00).setFont(font).hide();
  ...
  //serial input
  inputField  = cp5.addTextfield("serialInput").setPosition(20, 450).setSize(500, 30).setAutoClear(false).setLabel("").setFocus(true);
  ClearOutput = cp5.addButton("ClearOutput").setPosition(525, 425).setSize(70, 20).setLabel("Clear").setBroadcast(true).hide();
  ...
  G18.moveTo("CONNECT");
  G19.moveTo("CONNECT");
  cercle.moveTo("CONNECT");
  Run.moveTo("CONNECT");
}
void G17 (){};// Delta.send("G17");}
void G18 (){};// Delta.send("G18");}
void G19 (){};// Delta.send("G19");}
void cercle (){// Gdraw();
  //Delta.send("G92 X0 Y0 Z0");
  //Delta.send("G90");
  //Delta.send("G2 X0 Y0 I5 J0");
}
