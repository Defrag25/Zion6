...
void Zion6_refreshAS(){
  if( bScreen2 == false){ showBIGScrn2Init(); bScreen2=true;} 
  if ( listeAS[0] ) {   if(Angle1!=lAngle1){    showBIGScrn2(1,Angle1);     lAngle1=Angle1; }}
  if ( listeAS[1] ) {   if(Angle2!=lAngle2){    showBIGScrn2(2,Angle2);     lAngle2=Angle2; }}
  if ( listeAS[2] ) {   if(Angle3!=lAngle3){    showBIGScrn2(3,Angle3);     lAngle3=Angle3; }}
  if ( listeAS[3] ) {   if(Angle4!=lAngle4){    showBIGScrn2(4,Angle4);     lAngle4=Angle4; }}
  if ( listeAS[4] ) {   if(Angle5!=lAngle5){    showBIGScrn2(5,Angle5);     lAngle5=Angle5; }}
  if ( listeAS[5] ) {   if(Angle6!=lAngle6){    showBIGScrn2(6,Angle6);     lAngle6=Angle6; }}
}
...
void Zion6TransmitAll(){
  ...
  listeAS[0]?Serial2.print(Angle1):Serial2.print("*");Serial2.print(";");
  listeAS[1]?Serial2.print(Angle2):Serial2.print("*");Serial2.print(";");
  listeAS[2]?Serial2.print(Angle3):Serial2.print("*");Serial2.print(";");
  listeAS[3]?Serial2.print(Angle4):Serial2.print("*");Serial2.print(";");
  listeAS[4]?Serial2.print(Angle5):Serial2.print("*");Serial2.print(";");
  listeAS[5]?Serial2.print(Angle6):Serial2.print("*");Serial2.print(";");
  Serial2.println();
}
...
void Zion6ProcessFDC(){
  ...
  if (listePCF[0]) { bitRead(PCF1,0)?digitalWrite(FDC_REF1,1):digitalWrite(FDC_REF1,0); }// OK
  ...
  if (listePCF[5]) { bitRead(PCF6,1)?digitalWrite( PALPEUR,1):digitalWrite( PALPEUR,0); }
...
//  listePCF[7]?Serial.print(PCF8):Serial.print("*");Serial.print("|");
  ...
  double v0 = Angle1 ; if(!listeAS[0]) v0=0;
  double v1 = Angle2 ; if(!listeAS[1]) v1=0;
  double v2 = Angle3 ; if(!listeAS[2]) v2=0;
  double v3 = Angle4 ; if(!listeAS[3]) v3=0;
  double v4 = Angle5 ; if(!listeAS[4]) v4=0;
  double v5 = Angle6 ; if(!listeAS[5]) v5=0;
