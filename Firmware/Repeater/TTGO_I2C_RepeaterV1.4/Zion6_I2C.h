...
void Zion6ProcessFDC(){
  ...
  digitalWrite(FDC_REF2,(PCF2&&0b00000001)?HIGH:LOW);
  digitalWrite(FDC_REF3,(PCF3&&0b00000001)?HIGH:LOW);
  digitalWrite(FDC_REF4,(PCF4&&0b00000001)?HIGH:LOW);
  digitalWrite(FDC_REF5,(PCF5&&0b00000001)?HIGH:LOW);
  digitalWrite(FDC_REF6,(PCF6&&0b00000001)?HIGH:LOW);
