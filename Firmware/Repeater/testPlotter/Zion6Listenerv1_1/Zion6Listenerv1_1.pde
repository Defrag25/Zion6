// Listener modifié pour test Zion6
//
// désactivation de l'autoscale des axes (fixé à [0 - 360°]
// affichage de la valeur instantanée de toutes les variablkes en print (lignes 265-271) 
// à faire
