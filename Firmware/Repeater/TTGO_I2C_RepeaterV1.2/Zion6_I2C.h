...
void I2CSlavesAnalyse();
void Zion6_initPCF();

int liste[10]; // 10 esclaves maxi
...
bool listeAS[6] ={0,0,0,0,0,0}; // [0x40-0x45]
long tStart;
long tStop;
...
void Zion6_checkAS(){
  if ( listeAS[0] ) { Angle1 = (float)(AS1.getRawAngle())*AS5600_RAW_TO_DEGREES; }
  if ( listeAS[1] ) { Angle2 = (float)(AS2.getRawAngle())*AS5600_RAW_TO_DEGREES; }
  if ( listeAS[2] ) { Angle3 = (float)(AS3.getRawAngle())*AS5600_RAW_TO_DEGREES; }
  if ( listeAS[3] ) { Angle4 = (float)(AS4.getRawAngle())*AS5600_RAW_TO_DEGREES; }
  if ( listeAS[4] ) { Angle5 = (float)(AS5.getRawAngle())*AS5600_RAW_TO_DEGREES; }
  if ( listeAS[5] ) { Angle6 = (float)(AS6.getRawAngle())*AS5600_RAW_TO_DEGREES; }
}
void Zion6_refreshPCF(){
...
void Zion6_refreshAS(){
  ...
  if ( listeAS[4] ) {   if(Angle5!=lAngle5){    showScrn2(6,Angle5);     lAngle5=Angle5; }}
  if ( listeAS[5] ) {   if(Angle6!=lAngle6){    showScrn2(1,Angle6);     lAngle6=Angle6; }}
}
...
void Zion6ProcessFDC(){
  ...
  digitalWrite(FDC_REF1,(PCF1&&0b00000001)?HIGH:LOW);
  digitalWrite(FDC_REF2,(PCF1&&0b00000001)?HIGH:LOW);
  digitalWrite(FDC_REF3,(PCF1&&0b00000001)?HIGH:LOW);
  digitalWrite(FDC_REF4,(PCF1&&0b00000001)?HIGH:LOW);
  digitalWrite(FDC_REF5,(PCF1&&0b00000001)?HIGH:LOW);
  digitalWrite(FDC_REF6,(PCF1&&0b00000001)?HIGH:LOW);
